...
public static class Utils
{
    ...
    public static string UnixToDayHour(this int unixTime, int timezoneOffset)
    {
        var dtUtc = UnixToDateTime(unixTime);
        var dtLocal = dtUtc.AddSeconds(timezoneOffset);
        return dtLocal.ToString("dddd, hh:mm tt", CultureInfo.InvariantCulture);
    }
